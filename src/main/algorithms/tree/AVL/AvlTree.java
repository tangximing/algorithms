...
public class AvlTree<T extends Comparable<T>> {
    /**
     * root for AVL algorithms.algorithms.tree
     */
    public AvlTreeNode root;

    /**
     * class for the node in avl algorithms.algorithms.tree
     */
    class AvlTreeNode{
        public T data;
    ...
    /**
     * insert key to the algorithms.algorithms.tree
     * @param key
     */
    ...
    private AvlTreeNode remove(AvlTreeNode tree, AvlTreeNode target){
        ...
        if(cmp > 0){
            ...
            if(tree.left != null && tree.right != null){
                ...
                /**
                 * if the left or right is null, just assign the algorithms.algorithms.tree to its' left child of right child
                 */
        ...
        /**
         * update the height of the algorithms.algorithms.tree after deletion
         */
        if(tree != null)
            tree.height = Math.max(height(tree.left), height(tree.right)) + 1;
        return tree;
    ...
    /**
     * get the max value of the algorithms.algorithms.tree
     * @return
     */
    public T maximum(){
    ...
    /**
     * get the min value of the algorithms.algorithms.tree
     * @return
     */
    public T minimum(){
    ...
    /**
     * left left rotation for unbalanced algorithms.algorithms.tree node
     * @param node
     * @return
     */
    ...
    /**
     * right right rotation for unbalanced algorithms.algorithms.tree node
     * @param node
     * @return
     */
    ...
    /**
     * left right rotation for unbalanced algorithms.algorithms.tree
     * @param node
     * @return
     */
    ...
    /**
     * right left rotation for unbalanced algorithms.algorithms.tree
     * @param node
     * @return
     */
    ...
    /**
     * get the height of the algorithms.algorithms.tree
     * @return
     */
    public int height(){
        return height(root);
    ...
    /**
     * pring the avl algorithms.algorithms.tree
     */
    public void print() {
        if (root != null)
